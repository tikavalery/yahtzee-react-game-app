...
const threeOfKind = new SumDistro({ count: 3 , description: "Sum all dice if 4 are the same"});
...
const yahtzee = new Yahtzee({ score: 50 , description: "50 points for a yathzee"});
