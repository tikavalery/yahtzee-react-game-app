...
import { ones, twos, threes, fours, fives, sixes, threeOfKind, fourOfKind, fullHouse, smallStraight, largeStraight, yahtzee, chance } from './Rules2';
    ...
    return (
      <div className="ScoreTable">
        <section className="ScoreTable-section">
          <h2 className="ScoreTable-heading" >Upper</h2>
          <table cellSpacing="0">
            <tbody>
              <RuleRow
                name="Ones"
        ...
        <section className="ScoreTable-section ScoreTable-section-lower">
          <h2 className="ScoreTable-heading">Lower</h2>
          <table cellSpacing="0">
            <tbody>
              <RuleRow
                name="Three of Kind"
        ...
        <h2 className="ScoreTable-heading" >TOTAL SCORE: { this.getTotalScore()}</h2>
      </div>
    )
  }
}
